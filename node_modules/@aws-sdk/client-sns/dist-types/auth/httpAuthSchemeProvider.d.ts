 ...
 * @internal
 */
export interface SNSHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<SNSClientResolvedConfig, HandlerExecutionContext, SNSHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultSNSHttpAuthSchemeParametersProvider: (config: SNSClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<SNSHttpAuthSchemeParameters>;
/**
 * @internal
 */
